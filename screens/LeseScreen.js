      ...
      <View style={styles.head}>
        ...
        <View style={styles.Middle}>
          <Image
            ...
            height={100}
          />
          <Text style={styles.LoginText}>المتضرر</Text>
        ...
        <View style={styles.RadioOptions}>
          ...
          >
            <Stack
              ...
              maxW="300px"
            >
              <Checkbox value="1" colorScheme="yellow" size="sm" my={1}>
                ارمل
              </Checkbox>
              <Checkbox value="2" colorScheme="yellow" size="sm" my={1}>
                مطلق
              </Checkbox>
              <Checkbox value="3" colorScheme="yellow" size="sm" my={1}>
                متزوج
              </Checkbox>
              <Checkbox value="4" colorScheme="yellow" size="sm" my={1}>
                اعزب
              </Checkbox>
            </Stack>
          </Radio.Group>
